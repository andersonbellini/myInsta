...
export default class New extends Component {
  ...
  handleSelectImage=()=>{
    ImagePicker.showImagePicker({
        ...
        if(upload.error){
            ...
            //trabalhando com desestruturação de img HEIC ((IOS))
            let prefix;
            let ext;
            if(upload.name){
  ...
  handleSubmit = async () => {
    ...
    this.props.navigation.navigate.push('Feed');
  }
    ...
    return (
        <View style={StyleSheet.container} >
            <TouchableOpacity style={styles.selectButton} onPress={this.handleSelectImage} >
                <Text style={styles.selectButtonText}>Selecionar a imagem</Text>
            </TouchableOpacity>
